...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vscode-icons-feedstock/blob/master/LICENSE.txt)
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12087&branchName=master">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vscode-icons-feedstock?branchName=master">
          </a>
        </summary>
        <table>
...
Once the `conda-forge` channel has been enabled, `vscode-icons` can be installed with:

```
conda install vscode-icons
```

It is possible to list all of the versions of `vscode-icons` available on your platform with:
